package OldProject.Bot.Brutefinder;

import OldProject.Bot.BotInterface;
import OldProject.PhysicsEngine.Objects.Parts.Ball;
import OldProject.PhysicsEngine.Physics12.World;
import OldProject.PhysicsEngine.Physics3.Physics;
...
public class Brutefinder implements BotInterface {
    ...
    public void calcNextShot(int playerNumber) {
        ...
        if (World.DEBUG)
            System.out.println("Brutefinder: Push " + bestDir + ";" + bestPow + ": Successful: " + push + " - Expected path to hole: " + bestPlace);
    ...
    public void makeDatabase() {
        ...
        if (World.DEBUG)
            System.out.println("Brutefinder: Nodes: " + amountNodes + " | Connections: " + amountConnections + " | Connections removed: " + amountOfNotReplicableConnections);
        ...
        while (balls.size() > 0) {
            ...
            for (int i = 0; i < balls.size(); i++) {
                ...
                if (tBall.velocityCounter == 20) {
                    ...
                    if (World.DEBUG)
                        System.out.println("Brutefinder: Something went wrong: " + tBall.place + " - " + tBall.velocity);
                    balls.remove(i);
                    i--;
                }
            }
